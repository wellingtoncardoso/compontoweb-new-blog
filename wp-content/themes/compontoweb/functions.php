...
function cpw_scripts_styles(){
	...
	if(! is_admin()){
		...
		wp_enqueue_style('singleCss', get_stylesheet_directory_uri().'/assets/css/single.css', array(), '1.0.0');
	...
	/*Style*/	
	wp_enqueue_style('slickTheme',get_stylesheet_directory_uri().'/vendor/slick-theme.css', array(),'1.0.0');
	...
	wp_enqueue_script('slickMinJs',get_stylesheet_directory_uri().'/vendor/slick/slick.min.js', array('jquery'),'1.0.0', true);	
	wp_enqueue_script('bootstrapMinJs',get_stylesheet_directory_uri().'/vendor/bootstrap/bootstrap.min.js', array('jquery'),'5.0.2', true);
	wp_enqueue_script('bootstrapBundleMinJs',get_stylesheet_directory_uri().'/vendor/bootstrap/bootstrap-bundle.min.js', array('jquery'),'4.0.0', true);
	wp_enqueue_script('popperMinJs',get_stylesheet_directory_uri().'/vendor/bootstrap/popper.min.js', array('jquery'),'2.9.2', true);
